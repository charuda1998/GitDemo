...
public class GetOrderBookResponseObject {
	...
	protected List<GetOrderBookObjectRow> objJSONRows;
	...
	public List<GetOrderBookObjectRow> getObjJSONRows() {
		return objJSONRows;
	}

	public void setObjJSONRows(List<GetOrderBookObjectRow> objJSONRows) {
