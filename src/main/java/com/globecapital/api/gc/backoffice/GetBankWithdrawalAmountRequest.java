...
public class GetBankWithdrawalAmountRequest  extends GCApiRequest {

	public GetBankWithdrawalAmountRequest() throws AppConfigNoKeyFoundException {
		super();
	...
	public void setSegment(String segment) {
		addToReq(GCConstants.INDEX_BANKLIST_SEGMENT, segment);
	}
