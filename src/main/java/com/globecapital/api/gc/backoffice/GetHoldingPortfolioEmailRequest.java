...
public class GetHoldingPortfolioEmailRequest extends GCApiRequest {

	public GetHoldingPortfolioEmailRequest() throws AppConfigNoKeyFoundException {
		super();
	...
	// 	addToReq(GCConstants.INDEX_HOLDING_EMAIL_CLIENTCODE, clientCode);
	// }
