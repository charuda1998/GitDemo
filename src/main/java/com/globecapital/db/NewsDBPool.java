...
public class NewsDBPool implements DBPool {

	private static Logger log = Logger.getLogger(NewsDBPool.class);

	private static NewsDBPool instance = null;
	private static InitialContext context;
	private static BasicDataSource datasource;

	//Below bean initialized with value in ApplicationContextListener.
	public static String NEWS_DB_BEAN = ""; 
	...
	public static void initTomcatDataSource() {
		try {
			...
			datasource = (BasicDataSource) context.lookup("java:comp/env/jdbc/news");
	...
	public Connection getConnection() throws SQLException {
		...
		try {
			...
			Monitor.markFailure(NEWS_DB_BEAN, e.getMessage());
			throw e;
		}
	}
