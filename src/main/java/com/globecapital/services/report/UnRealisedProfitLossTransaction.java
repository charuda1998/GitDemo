...
public class UnRealisedProfitLossTransaction extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getProfitLossTransactionReports = ProfitLoss.getUnRealisedProfitLossTransaction(session,
				 maxSlot,transApiObj);
