...
public class RealisedProfitLossTransaction extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getProfitLossTransactionReports = ProfitLoss.getRealisedProfitLossTransaction(session,
				 maxSlot,transApiObj);
