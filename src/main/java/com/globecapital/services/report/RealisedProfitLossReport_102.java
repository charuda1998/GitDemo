...
public class RealisedProfitLossReport_102 extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getProfitLossReports = ProfitLoss_101.getRealisedProfitLossReports(session, segmentType,
