...
import com.globecapital.business.report.Holdings_101;
...
public class HoldingsReport_101 extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getHoldingsReports = Holdings_101.getHoldingsReports(session,filterObj,DeviceConstants.HOLDINGS);
