...
public class TransactionReport_103 extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getTransactionReports = Transaction_101.getTransactionReports_101(session, segmentType,filterObj,DeviceConstants.TRANSACTION);
