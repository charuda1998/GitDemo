...
public class RealisedProfitLossTransaction_101 extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONArray getProfitLossTransactionReports = ProfitLoss.getRealisedProfitLossTransaction_101(session,
				 maxSlot,transApiObj);
