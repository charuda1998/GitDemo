...
public class OrderBook_102 extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception
	 {
		...
		orderBookObj = com.globecapital.business.order.OrderBook_102.getOrderBook(orderRows, tradeRows, sOrderStatus);
