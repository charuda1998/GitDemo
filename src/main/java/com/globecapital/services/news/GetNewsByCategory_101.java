...
public class GetNewsByCategory_101 extends BaseService {
	...
	protected void process(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		if(paginationObj!=null && !paginationObj.has(DeviceConstants.TIME))
			paginationObj = null;
		JSONObject newsObj = NewsFeed.getNewsByCategoryFromDB_101 (gcRequest.getAppID(), category, paginationObj);
