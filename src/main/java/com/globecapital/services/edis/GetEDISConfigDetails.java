...
public class GetEDISConfigDetails extends SessionService{
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		{
			if(!isPOAUser)
				gcResponse.setData(com.globecapital.business.edis.GetEDISConfigDetails_101.getEDISApprovalDetails_101(session, approvalDetails, isApproveAll, isHoldingsFlow,getServletContext(),gcRequest,gcResponse));
			else
