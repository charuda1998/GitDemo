...
import com.globecapital.business.funds.GetBankWithdrawalAmount;
...
public class BankWithdrawalAmount extends SessionService {
	...
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		...
		JSONObject withdrableAmtObj = GetBankWithdrawalAmount.withdrawalAmount(session, segmentType);
