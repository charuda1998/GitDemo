...
public class GetWatchlist_101 extends SessionService {

	private static final long serialVersionUID = 1L;

	@Override
	protected void doPostProcess(GCRequest gcRequest, GCResponse gcResponse) throws Exception {
		JSONObject watchlist = Watchlist.getWatchlist_101(gcRequest.getSession(), gcRequest.getSession().getUserID(),getServletContext(), gcRequest,  gcResponse);
