...
public class DerivativePositions_103 {

	private static Logger log = Logger.getLogger(DerivativePositions_103.class);
	...
	public static JSONObject getDerivativePositions(List<GetNetPositionRows> todayPositionRows, Session session,
			JSONObject filterObj, ServletContext servletContext, GCRequest gcRequest, GCResponse gcResponse)
			throws Exception {
		...
		Map<String, JSONObject> mDerivativePositionTokenSegmentAvgPrice = getDerivativePositionFromGCAPI(
		...
		PositionsHelper_101.getMarketValueAndPLUsingLTP(positionsList, linkedsetSymbolToken);
	...
	public static JSONObject getDerivativePositions_101(List<GetNetPositionRows> todayPositionRows, Session session,JSONObject filterObj, ServletContext servletContext,GCRequest gcRequest,GCResponse gcResponse)
			throws Exception {
		JSONObject finalObj = new JSONObject();
		JSONArray positionsList = new JSONArray();
		LinkedHashSet<String> linkedsetSymbolToken = new LinkedHashSet<String>();
	...
	public static JSONObject getDerivativePositions_102(List<GetNetPositionRows> todayPositionRows,List<GetNetPositionRows> positionRows ,Session session, JSONObject filterObj)
