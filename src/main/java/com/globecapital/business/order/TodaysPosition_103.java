...
public class TodaysPosition_103 {

	private static Logger log = Logger.getLogger(TodaysPosition_103.class);
	...
	public static JSONObject getPositions_101(List<GetNetPositionRows> positionRows, String sUserID,
			String sAppID, JSONObject filterObj) throws JSONException, GCException, SQLException, ParseException {
